...
export const COMPONENT_INVENTORY = [
	...
	{ name: 'Button toggle', category: 'Basic', status: 'implemented', docsPath: DOCS_PATHS.buttonToggle },
	...
	{ name: 'Datepicker', category: 'Form', status: 'implemented', docsPath: DOCS_PATHS.datepicker },
	...
	{ name: 'Grid list', category: 'Data', status: 'planned' },
	{
		...
		status: 'implemented',
		plimName: 'Material Symbols guide',
	...
	{ name: 'Progress bar', category: 'Basic', status: 'implemented', docsPath: DOCS_PATHS.progressBar },
	{
	...
	{ name: 'Slider', category: 'Form', status: 'implemented', docsPath: DOCS_PATHS.slider },
	...
	{ name: 'Timepicker', category: 'Form', status: 'implemented', docsPath: DOCS_PATHS.timepicker },
